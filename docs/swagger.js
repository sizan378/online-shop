...
const doc = {
  info: {
    ...
    title: 'Online Apis',        // by default: 'REST API'
    description: 'API for Managing queue calls',  // by default: ''
    contact: {
        'name': 'API Test',
        'email': 'sizanmahmud08@gmail.com'
    },
  },
  host: 'localhost:5002',      // by default: 'localhost:5002'
  basePath: '/',  // by default: '/'
  ...
  tags: [        // by default: empty Array
    {
      name: 'online-shop',         // Tag name
      description: 'online-shop related apis',  // Tag description
    },
    {
        name: 'online-shop',
        description: 'Online shop Check'
    }
  ],
